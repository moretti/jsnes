...
Mappers[0].prototype = {
    ...
    loadVromBank: function(bank, address) {
        ...
        copyArrayElements(this.nes.rom.vrom[bank % this.nes.rom.vromCount],
    ...
    load1kVromBank: function(bank1k, address) {
        ...
        copyArrayElements(this.nes.rom.vrom[bank4k], 0,
    ...
    load2kVromBank: function(bank2k, address) {
        ...
        copyArrayElements(this.nes.rom.vrom[bank4k], bankoffset,
    ...
    load8kRomBank: function(bank8k, address) {
        ...
        copyArrayElements(this.nes.rom.rom[bank16k], offset,
